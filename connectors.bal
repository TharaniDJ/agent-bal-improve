...
public final Connector[] & readonly ALL_CONNECTORS = [
    {name: "HubSpot Automation Actions",             docsUrl: "https://github.com/HubSpot/HubSpot-public-api-spec-collection", targetTitle: ()},
    {name: "HubSpot CRM Associations",               docsUrl: "https://github.com/HubSpot/HubSpot-public-api-spec-collection", targetTitle: ()},
